...
import { LOGO, SUPPORT_LANGAUGE } from "../utils/constant";
    ...
    <div className="absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between bg-black ">
      ...
      {user && (
        <div className="flex p-2 justify-between">
          {showGptSearch && (
            <select className="p-2 m-2 bg-gray-900 text-white" onChange={handleLangaugeChange}>
              {SUPPORT_LANGAUGE.map((lang) => (
          ...
          <img className="hidden md:inline-block w-12 h-12" alt="usericon" src={user?.photoURL}></img>
